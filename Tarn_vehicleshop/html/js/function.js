...
function viewvehicle() {
    $.post('http://Tarn_vehicleshop/openfocus');
}

function TestDrive() {
    if (choosemodelcar) {
        $.post('http://Tarn_vehicleshop/testcar', JSON.stringify({
...
function ChooseColorCar_1(color) {
    ...
    color_1 = color
    $.post('http://Tarn_vehicleshop/choosecolor1', JSON.stringify({
        color: color,
    }));
}
function ChooseColorCar_2(color) {
    ...
    color_2 = color
    $.post('http://Tarn_vehicleshop/choosecolor2', JSON.stringify({
        color: color,
    }));
}
